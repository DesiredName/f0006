export default function ArrowTemplate(number_of_videos) {
    switch (number_of_videos) {
        case 's': 
            return `
                <span class="video_marker short">
                    <span class="figure">
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
  <g transform="translate(-1, -1)" fill="transparent"><path class="primary style-scope yta-line-chart-base" d="M15.2365 7.53886C16.9148 6.57982 17.4979 4.44183 16.5388 2.76352C15.5798 1.08521 13.4418 0.502118 11.7635 1.46115L4.7635 5.46115C3.61069 6.1199 2.92989 7.37425 3.0057 8.69984C3.08151 10.0254 3.90087 11.194 5.12127 11.717L5.66097 11.9483L4.7635 12.4612C3.08519 13.4202 2.5021 15.5582 3.46114 17.2365C4.42017 18.9148 6.55816 19.4979 8.23647 18.5389L15.2365 14.5389C16.3893 13.8801 17.0701 12.6258 16.9943 11.3002C16.9185 9.97458 16.0991 8.80603 14.8787 8.283L14.339 8.0517L15.2365 7.53886ZM8.5 7.5L8.5 12.5L13 10L8.5 7.5Z" fill="currentColor" fill-rule="evenodd" transform="scale(0.8888)"></path></g>
</svg>
                    </span>
                </span>
            `;
